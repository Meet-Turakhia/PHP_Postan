...
@-webkit-keyframes animate {
  from {-webkit-transform: translate(1em,0em)} 
  to {-webkit-transform: translate(0em,0em)}
}
  
@keyframes animate {
  from {transform:  translate(3em,0em)} 
...
@-webkit-keyframes animate3 {
  from {-webkit-transform: translate(0em,1em)} 
  to {-webkit-transform: translate(0em,0em)}
}
  
@keyframes animate3 {
  from {transform:  translate(0em,3em)} 
  to {transform:  translate(0em,0em)}
}
</style>
</head>
...
<body>
                <div>
                    ...
                    <div class="form-group form-popup-chatbot" id="chatbot">
                        ...
                        <center><label for="exampleFormControlFile1"><h5 style='font-size:24px; color: #ffcc00;'><i class='fas fa-user-astronaut' style='font-size:25px; color: #ffcc00;'></i> STANBOT</h5><small id="emailHelp" class="form-text text-muted">Encryption by Team Postan</small><div class='dropdown-divider'></div><h6 style="color: white;">Hello, how can i help you ?</h6></label></center>
                        <div class="botmsg animate2"><p style="color:black;" id="bot"></p></div>
